...
export const BEATAINDRUNAS_MENTORINGtxtNodesModel = model('beataindrunas_mentoring_text_node', textNodeSchema);
...
export const NIKAANDSOULS_HOMEtxtNodesModel = model('nikaandsouls_home_text_node', textNodeSchema);
